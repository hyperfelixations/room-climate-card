...
export const outdoor = {
  ...
  comparison: ">=",
  tiers: [
    { min: 35, score: 11, levelKey: "level.veryHot", zone: "outside" },
    { min: 30, score: 10, levelKey: "level.hot", zone: "outside" },
    { min: 28, score: 9, levelKey: "level.veryWarm", zone: "outside" },
    { min: 26, score: 8, levelKey: "level.warm", zone: "outside" },
    { min: 22, score: 7, levelKey: "level.slightlyWarm", zone: "comfort" },
    { min: 18, score: 6, levelKey: "level.optimal", zone: "optimal" },
    { min: 14, score: 5, levelKey: "level.slightlyCool", zone: "comfort" },
    { min: 10, score: 4, levelKey: "level.fresh", zone: "outside" },
    { min: 5, score: 3, levelKey: "level.cool", zone: "outside" },
    { min: 0, score: 2, levelKey: "level.cold", zone: "outside" },
