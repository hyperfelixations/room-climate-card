...
export const pl = {
  ...
  "availability.valueNotNumeric": "Encja nie podaje liczby.",
  "availability.valueImpossible": "Encja podaje wartość fizycznie niemożliwą.",
  ...
  "warning.unitAmbiguous": (v) => `${v.entity} wymaga device_class; jednostka pasuje do kilku typów pomiaru.`,
  "warning.unidentified": (v) => `${v.entity} nie ma ani device_class, ani jednostki znanej karcie.`,
  "warning.unitUnreadable": (v) => `${v.entity} podaje jednostkę, której karta nie może tu odczytać.`,
  "warning.otherMeasurement": (v) => `${v.entity} mierzy coś innego i jest ignorowana.`,
  "hint.roomsUnavailable": (v) =>
    `${v.count} ${selectPlural("pl", v.count, { one: "pokój jest obecnie niedostępny", few: "pokoje są obecnie niedostępne", many: "pokoi jest obecnie niedostępnych", other: "pokoju jest obecnie niedostępne" })}.`,
  "hint.primaryUnavailable": "Główny czujnik jest obecnie niedostępny; średnia z pokoi.",
  "hint.rangeUnavailable": "Dzisiejszy zakres jest obecnie niedostępny.",
  "hint.trendUnavailable": "Trend jest obecnie niedostępny.",
  "hint.several": (v) =>
    `${v.count} ${selectPlural("pl", v.count, { one: "źródło jest obecnie niedostępne", few: "źródła są obecnie niedostępne", many: "źródeł jest obecnie niedostępnych", other: "źródła jest obecnie niedostępne" })}.`,
  "value.empty": "(puste)",
