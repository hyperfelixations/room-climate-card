...
export const nb = {
  ...
  "warning.unitAmbiguous": (v) => `${v.entity} trenger en device_class; enheten passer til flere måletyper.`,
  "warning.unidentified": (v) => `${v.entity} har verken device_class eller en enhet kortet kjenner.`,
  "warning.unitUnreadable": (v) => `${v.entity} oppgir en enhet kortet ikke kan lese her.`,
  "warning.otherMeasurement": (v) => `${v.entity} måler noe annet og ignoreres.`,
  "hint.roomsUnavailable": (v) => `${v.count} rom er for øyeblikket ${v.count === 1 ? "utilgjengelig" : "utilgjengelige"}.`,
  "hint.primaryUnavailable": "Hovedsensoren er for øyeblikket utilgjengelig; snitt av rommene.",
  "hint.rangeUnavailable": "Dagens spenn er for øyeblikket utilgjengelig.",
  "hint.trendUnavailable": "Trenden er for øyeblikket utilgjengelig.",
  "hint.several": (v) => `${v.count} kilder er for øyeblikket utilgjengelige.`,
  "value.empty": "(tom)",
