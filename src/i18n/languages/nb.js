// Norwegian Bokmål UI strings. Same key set as en.js (reference + per-key fallback),
// checked at load by ../integrity.js. Value shapes and plural rules: see internal dev doc §5 "i18n und sprachabhängige Formatierung".
...
export const nb = {
  ...
  "scale.bandRangeSigned": (v) => `${v.min} til ${v.max}`,
